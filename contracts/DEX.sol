...
contract DEX is ReentrancyGuard {
    ...
    function addLiquidity(
        ...
        if (totalLiquidity == 0) {
            ...
            // Requirement: Maintain current price ratio
    ...
    function removeLiquidity(
        ...
        require(
            ...
            "DEX: INSUFFICIENT_LIQUIDITY_BALANCE"
        );
    ...
    function swapAForB(
        ...
        require(amountAIn > 0, "DEX: INSUFFICIENT_INPUT_AMOUNT");
    ...
    function swapBForA(
        ...
        require(amountBIn > 0, "DEX: INSUFFICIENT_INPUT_AMOUNT");
    ...
    function getPrice() external view returns (uint256 price) {
        ...
        // Returning price as reserveB / reserveA, scaled to 1e18 for precision
